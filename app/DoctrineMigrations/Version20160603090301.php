 ...
 */
class Version20160603090301 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE country (id INT AUTO_INCREMENT NOT NULL, iso VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, nice_name VARCHAR(255) NOT NULL, iso3 VARCHAR(255) NOT NULL, numcode INT NOT NULL, phonecode INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, counsellor_id INT NOT NULL, type VARCHAR(255) DEFAULT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, username VARCHAR(255) DEFAULT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, mobile INT NOT NULL, gender VARCHAR(255) NOT NULL, nationality VARCHAR(255) DEFAULT NULL, dob DATE DEFAULT NULL, birth_country VARCHAR(255) DEFAULT NULL, birth_city VARCHAR(255) DEFAULT NULL, remember_token VARCHAR(100) DEFAULT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_8D93D6498781E5CF (counsellor_id), UNIQUE INDEX user_username_unique (username), UNIQUE INDEX user_email_unique (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE counsellor ADD CONSTRAINT FK_D58EABE9FFA0C224 FOREIGN KEY (office_id) REFERENCES office (id)');
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D6498781E5CF FOREIGN KEY (counsellor_id) REFERENCES counsellor (id)');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE user DROP FOREIGN KEY FK_8D93D6498781E5CF');
